	...
	#if BEAUTIFY_DEPTH_OF_FIELD_TRANSPARENT
		float depth  = UNITY_SAMPLE_DEPTH(tex2Dlod(_CameraDepthTexture, uv));
	    float depthTex = UNITY_SAMPLE_DEPTH(tex2Dlod(_DepthTexture, uv));
