...
public class MainMenu : MonoBehaviour
{
    ...
    public void levelSelectButtons()
    {
        ...
        {
            int stars =2;// ConfigReader.Instance.getValueInt("StarsLevel" + (i + 1));
            if (stars > 0)
            {
        ...
        for(int i = 0; i < forwardArrows.Length; i++)
        {
            ...
            int stars = 2;// ConfigReader.Instance.getValueInt("StarsLevel" + (i + increes));
            if(stars > 0)
            {
        ...
        for(int i = 1; i < 15; i++)
        {
            int stars = 2;// ConfigReader.Instance.getValueInt("StarsLevel" + (i));
            if (stars > 0)
            {
