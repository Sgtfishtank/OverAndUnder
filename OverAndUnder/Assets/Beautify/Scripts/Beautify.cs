...
//			dofLastFocusCheck = -100;
		...
		void OnPreRender ()
		{
			...
			RenderTexture depthTexture = RenderTexture.GetTemporary (cameraEffect.pixelWidth / _depthOfFieldDownsampling, cameraEffect.pixelHeight / _depthOfFieldDownsampling, 24, RenderTextureFormat.ARGB32);
